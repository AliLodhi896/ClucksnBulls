                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-xl-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="category_description" id="validationDefault01" value="<?php echo "$rec[category_description]" ?>" required>
                                                    </div>
                                        ...
                                        if(isset($_POST["update_btn_category"]))
                                        {
                                            ...
                                            $price = $_POST["price"];
                                                ...
                                                if($update_excec)
                                                {
                                                    ?>
                                                        <script>
                                                            alert("Record has been updated");window.location.href = "manage_cateogry.php";
                                                        </script>
                                                    <?php
                                                }
                                                else
