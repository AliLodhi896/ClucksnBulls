                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a href="index.php" class="logo-name" style="position:relative;left:120px">
                            ...
                            <!--    alt="logo">-->
                            <h1 class="header-brand-img light-logo1 mylogo" style="margin-left:-35px;font-weight: bold;">Clucks & Bulls</h1>
                        </a>
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                ...
                                                <!--    class="avatar  profile-user brround cover-image">-->
                                                    ...
                                                    <i class="fas fa-user avatar  profile-user brround cover-image" style="font-size:19px" aria-hidden="true"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    ...
                                                    <?php
                                                            ...
                                                            {
                                                                ?>
                                                                <h5 class="text-dark mb-0 fs-14 fw-semibold">Ali Lodhi</h5>
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.php">
                            ...
                            <h2 class="header-brand-img desktop-logo" style="margin-left:-12px;font-weight: bold;color:white"> Clucks & Bulls</h2>
                            <h6 class="header-brand-img toggle-logo" style="margin-left:-35px;font-weight: bold;">Clucks & Bulls</h6>
                            <h6 class="header-brand-img light-logo" style="margin-left:-12px;font-weight: bold;"> Clucks & Bulls</h6>
                            <h2 class="header-brand-img light-logo1" style="margin-left:-35px;font-weight: bold;">Clucks & Bulls</h2>
                        </a>
                        <!-- LOGO -->
                    </div>
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="create_menu.php"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Add Menu</span></a>
                            </li>
                            
                                                        <li class="slide">
                                <a class="side-menu__item" href="create_project.php"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Add Project</span></a>
                            </li>
                            ...
                            <?php
                                ...
                                if(isset($_SESSION["role"]) && $_SESSION["role"] == "Admin")
                                {
                                    ?>
                                     ...
                                     <li class="slide">
                                        <a class="side-menu__item" href="manage_staff.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Staff</span></a>
                                    </li>
                            ...
                            ?>
                            <li class="slide">
                                <a class="side-menu__item" href="manage_projects.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Projects</span></a>
                            </li>
