                            ...
                            <!-- ROW-1 -->
                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION["role"]) && $_SESSION["role"] == "Admin")
                                    {
                                        ...
                                        <h2 class="side-menu__icon page-title">Staff</h2>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <p class="font-medium-2">Total Staff</p>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role = 'Staff' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role = 'Staff' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
