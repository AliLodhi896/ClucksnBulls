                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-xl-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="description" id="validationDefault01" value="">
                                                    </div>
                                                    <div class="col-xl-6 mb-3">
                                                        <label for="validationDefault01">Long Description</label>
                                                        <input type="text" class="form-control" name="long_description" id="validationDefault01" value="">
                                                    </div>
                                                </div>
                                                <div class="form-row">
